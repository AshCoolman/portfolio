// Version: v1.0.0-pre.3-1-g30d8f7d
// Last commit: 30d8f7d (2013-01-17 10:57:05 -0800)
...
// Version: v1.0.0-pre.3-14-gdbb3548
// Last commit: dbb3548 (2013-01-17 22:37:08 -0800)
...
/**
  ...
  Within an `Ember.Router`-managed application single shared instances of every
...
/** @scope Ember.EventDispatcher.prototype */{
  ...
  */
  setup: function(addedEvents) {
    ...
    Ember.assert('You cannot make a new Ember.Application using a root element that is a descendant of an existing Ember.Application', !rootElement.closest('.ember-application').length);
...
/**
  `Ember.CollectionView` is an `Ember.View` descendant responsible for managing
