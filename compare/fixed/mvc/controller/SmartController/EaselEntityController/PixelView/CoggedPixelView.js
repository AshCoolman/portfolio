App.CoggedPixelView = App.PixelView.extend({
	...
	override_createEasel: function () {
		...
		this.cogView = cogView = App.CogView.create( { controller: App.CogController.create() });
	...
	willDestroyElement: function () {
		console.log('COGGED PIXEL VIEW DESTROYED')
		//App.static_easelEntityContainerView.removeChild(this.cogView);
	}
