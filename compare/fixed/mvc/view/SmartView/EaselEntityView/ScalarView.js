App.ScalarView = App.EaselEntityView.extend({
	...
	init: function() {
		//console.log('init Scalar View', App.static_easelEntityContainerView, this)
	...
	override_createEasel: function() {
		...
		if (this.shp) {
			console.log('shp already exists...', this.shp)
			throw 'shp already exists'
		}
	...
	willDestroyElement: function () {
		console.log('Scalar.willDestroyElement')
		this.shp = null
	}
